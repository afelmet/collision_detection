...
// CollisionFactory::getCollisionDetector(collision_detection::CollisionLibrary
// library, OctreeDebugConfig octree_debug_config, bool use_contact_info)
[[nodiscard]] AbstractCollisionPtr
CollisionFactory::getCollisionDetector(CollisionDetectionConfig collision_detection_config)
{
    ...
    {
        // 		collision_detector =
        // std::make_shared<FCLCollisionDetection>(octree_debug_config);
